import type { NetworkArchitecture } from "./gcp-network";

export const SAMPLE_ARCHITECTURES: NetworkArchitecture[] = [
  {
    version: "1.0.0",
  ...
  {
    version: "1.0.0",
    name: "Risky public SSH sample",
    description: "A small intentionally risky architecture used to demonstrate planner warnings.",
    components: [
      {
        id: "project-dev",
        kind: "project",
    ...
    connections: [
      { id: "rc1", sourceId: "project-dev", targetId: "vpc-dev", kind: "attachment" },
      { id: "rc2", sourceId: "vpc-dev", targetId: "subnet-dev", kind: "attachment" },
      { id: "rc3", sourceId: "subnet-dev", targetId: "vm-risky", kind: "attachment" },
      { id: "rc4", sourceId: "vpc-dev", targetId: "fw-risky-ssh", kind: "attachment" },
      { id: "rc5", sourceId: "internet-dev", targetId: "vm-risky", kind: "reference" },
    ],
  },
];
